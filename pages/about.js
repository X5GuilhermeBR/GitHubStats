...
import { AboutPage, CardGroup, BackButton, ServerCard, Section } from '../styles/styles'
...
const About = () => {
  return (
    <AboutPage maxWidth="md">
      ...
      <Section>
        <h1 className="no-margin">Time Dev</h1>
        <CardGroup>
          <InfoCard
            name="Guilherme José"
      ...
      <Section>
        ...
        <ServerCard>
          <img
            src="https://avatars2.githubusercontent.com/u/65730630?s=460&u=2e1f6eaa101fec9e605dadaade686cb95a2e9f5b&v=4"
            alt="Cadê meu Café"
            className="image"
          />
          <div className="info">
